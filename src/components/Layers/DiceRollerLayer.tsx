...
import {
  DiceRollerState,
  DiceRollerContext,
} from "../../classes/DiceRollerStates";
//------------------------------------------------------------------< classes >
import { InitialState } from "../../classes/DiceRollerStates/InitialState";
//---------------------------------------------------------------< components >
import { Layer } from ".";
//------------------------------------------------------------------< helpers >
...
//======================================================[ < DiceRollerLayer > ]
export function DiceRollerLayer({ dice, onRoll, children, ...props }: IProps) {
  //-------------------------------------------------------------< properties >
  const originState = useState<Vector>(zero);
  const pullState = useState<Vector>(zero);
  const [state, setState] = useState<DiceRollerState>(new InitialState());
  //---------------------------------------------------------------------------
